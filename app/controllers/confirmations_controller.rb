class ConfirmationsController < Devise::ConfirmationsController
 ...
 private
   def permitted_params # Make sure to update this in the users controller as well
     params.require(resource_name).permit(:username, :password, :password_confirmation, :remember_me, :team_id, :team_captain, :email, :name, :school, :year_in_school, :gender, :play_for_money, :still_compete,:age, :area_of_study, :location, :personal_email, :resume, :verification)
   end
end