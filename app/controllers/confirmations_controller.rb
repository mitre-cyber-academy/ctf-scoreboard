class ConfirmationsController < Devise::ConfirmationsController
 ...
 private
   def permitted_params # Make sure to update this in the users controller as well
     params.require(resource_name).permit(:username, :password, :password_confirmation, :remember_me, :team_id, :team_captain, :email, :name, :school, :year_in_school, :gender, :compete_for_prizes, :age, :area_of_study, :state)
   end
end